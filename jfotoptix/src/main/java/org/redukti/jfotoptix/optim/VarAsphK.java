...
public class VarAsphK extends Var {
    ...
    public VarAsphK(Prescription prescription, int surfaceId) {
        super(prescription, prescription.surfaces[surfaceId]._k,0.0001);
        this.surfaceId = surfaceId;
    }
    @Override
    public void shift(double delta) {
        prescription.surfaces[surfaceId]._k = originalValue + delta;
    }
    @Override
    public String toString() {
        return "Surface ID: " + surfaceId + " Asph k: " + prescription.surfaces[surfaceId]._k;
    }
}
