...
public class RayTracer {
    ...
    public RayTracer(OpticalSystem system) {
        this.system = system;
    }

    void trace_sequential(Renderer.IntensityMode m, TraceParameters parameters, RayTraceResults result) {

        //result.init (_system);

        // stack of rays to propagate
        //List<TracedRay> tmp[] = new ArrayList<TracedRay>[2];
...
//            swaped ^= 1;
    ...
    {
        TraceParameters params = result.parameters;
...
//        }
    ...
    private Vector3Pair intersect(OpticalSurface surface, TraceParameters params, Vector3Pair ray) {
    ...
    private Vector3Pair intersect (Stop surface, TraceParameters params, Vector3Pair ray)
    {
        Vector3 origin = surface.get_curve().intersect (ray);
        if (origin == null)
            return null;
