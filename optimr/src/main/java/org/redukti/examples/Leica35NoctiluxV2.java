...
public class Leica35NoctiluxV2 {
    ...
    private static Prescription getPrescription(String specfile) throws Exception {
        ...
        return Prescription.build_prescription_d_line(specs);
    }
