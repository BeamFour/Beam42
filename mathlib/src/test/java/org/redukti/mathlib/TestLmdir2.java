...
/* http://www.netlib.org/minpack/ex/file17 */
...
//         nprob = nprobfile[iii];
            ...
            TestLmdir2 lmdertest = new TestLmdir2();
            ...
            for (k = 1; k <= ntries; k++) {
                ...
                TestLmdir2.initpt(n,x,lmdertest.nprob,factor);

                TestLmdir2.ssqfcn(m,n,x,fvec,lmdertest.nprob);
...
*/
    ...
    public static void ssqjac(int m, int n, double x[], double fjac[],
                              int nprob) {
