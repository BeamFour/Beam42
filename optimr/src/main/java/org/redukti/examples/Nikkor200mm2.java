...
//                        new GoalSpotMaxRadius(analysis, 4, 60.0, 1.0),
                        ...
                        new GoalGeoMTF(analysis,1,0,10,0.85,1.0),
                        new GoalGeoMTF(analysis,1,1,10,0.85,1.0),
                        new GoalGeoMTF(analysis,2,0,10,0.87,1.0),
                        new GoalGeoMTF(analysis,2,1,10,0.87,1.0),
                        new GoalGeoMTF(analysis,3,0,10,0.88,1.0),
                        new GoalGeoMTF(analysis,3,1,10,0.87,1.0),
                        new GoalGeoMTF(analysis,4,0,10,0.85,1.0),
                        new GoalGeoMTF(analysis,4,1,10,0.8,1.0),
                        // below are figures from patent
                        new GoalGeoMTF(analysis,1,0,30,0.55,1.1),
                        new GoalGeoMTF(analysis,1,1,30,0.55,1.1),
                        new GoalGeoMTF(analysis,2,0,30,0.56,1.0),
                        new GoalGeoMTF(analysis,2,1,30,0.52,1.0),
                        new GoalGeoMTF(analysis,3,0,30,0.5,1.0),
                        new GoalGeoMTF(analysis,3,1,30,0.52,1.0),
                        new GoalGeoMTF(analysis,4,0,30,0.4,1.0),
                        new GoalGeoMTF(analysis,4,1,30,0.3,1.0),

                        new GoalGeoMTF(analysis,1,0,50,0.53,1.0),
                        new GoalGeoMTF(analysis,1,1,50,0.53,1.0),
                        new GoalGeoMTF(analysis,2,0,50,0.4,1.0),
                        new GoalGeoMTF(analysis,2,1,50,0.36,1.0),
                        new GoalGeoMTF(analysis,3,0,50,0.3,1.0),
                        new GoalGeoMTF(analysis,3,1,50,0.3,1.0),
                        new GoalGeoMTF(analysis,4,0,50,0.3,1.0),
                        new GoalGeoMTF(analysis,4,1,50,0.2,1.0),
