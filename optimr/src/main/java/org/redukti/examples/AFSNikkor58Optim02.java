...
public class AFSNikkor58Optim02 {
   ...
   private static Prescription getPrescription() {
        Prescription prescription = new Prescription(58.0216,1.45,41.72,43.2,false)
                .surf(52.8577, 6.0, 47.2, 1.74443, 49.53,	"N-LAK28", "Schott")
                .asph( SurfaceType.ASPH_EVEN,-0.4279,new double[]{0.,1.10084E-07,6.21998E-10,4.25694E-13,0.0})
                .surf(229.3475,	0.1,	47.2)
                .surf(40.3738,	6.0,	39.6,1.755,	52.34,	"J-LASKH2", "Hikari")
                .surf( 354.9744, 1.5, 39.6, 1.48749, 70.31, "J-FK5", "Hikari")
                .surf( 42.4134,	4.1038, 35.1)
                .surf(290.8467, 1.5, 34.0, 1.68893, 31.16, "J-SF8", "Hikari")
                .surf(31.6359,6.0,33.0)
                .stop(6.0,	28.261)
                .surf(-30.7873,	1.7,		30.0,	1.72825,28.46,	"SF10", "Hikari")
                .surf(35.1427,	7.0,		33.5,	1.883,40.77,	"J-LASF08A", "Hikari")
                .surf(-131.1407,	0.1,		33.5)
                .surf(118.7661,	6.0, 33.8, 1.883, 40.77, "J-LASF08A", "Hikari")
                .surf(-44.2318,	1.5,		33.8,1.53172,	48.78,	"J-LLF6", "Hikari")
                .surf(44.2683,	6.0, 	33.8, 1.7443, 49.53, "N-LAK28", "Hikari")
