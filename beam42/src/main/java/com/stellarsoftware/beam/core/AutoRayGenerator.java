...
/** AutoRay.java
  ...
  */
public class AutoRayGenerator implements B4constants
{
    //----------parallel with InOut-------------
    ...
    public int ngoals      = 0;
    public int navail      = 0;
    public int nfinishes   = 0;
    public int nwentbad    = 0;
    ...
    public Comparo getResults() {
        Comparo comparo = new Comparo(optEditor, rayEditor, rt13);
        comparo.doResiduals();
...
class LMray implements B4constants
{
    ...
    private AutoRayGenerator myH = null;    // overwritten by constructor
    ...
    public LMray(AutoRayGenerator gH, double gtol, int gnparms, int gnpts)
