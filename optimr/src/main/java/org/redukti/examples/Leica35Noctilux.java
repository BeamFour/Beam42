...
//                        new GoalSpotMaxRadius(analysis, 4, 60.0, 1.0),
                        ...
                        new GeoMTF(analysis,1,0,20,0.9,1.0),
                        new GeoMTF(analysis,1,1,20,0.9,1.0),
                        new GeoMTF(analysis,2,0,20,0.9,1.0),
                        new GeoMTF(analysis,2,1,20,0.9,1.1),
                        new GeoMTF(analysis,3,0,20,0.8,1.0),
                        new GeoMTF(analysis,3,1,20,0.8,1.1),
                        new GeoMTF(analysis,4,0,20,0.7,1.0),
                        new GeoMTF(analysis,4,1,20,0.5,1.1),

                        new GeoMTF(analysis,1,0,40,0.8,1.0),
                        new GeoMTF(analysis,1,1,40,0.8,1.0),
                        new GeoMTF(analysis,2,0,40,0.7,1.0),
                        new GeoMTF(analysis,2,1,40,0.7,1.1),
                        new GeoMTF(analysis,3,0,40,0.6,1.0),
                        new GeoMTF(analysis,3,1,40,0.6,1.1),
                        new GeoMTF(analysis,4,0,40,0.5,1.0),
                        new GeoMTF(analysis,4,1,40,0.3,1.1),
