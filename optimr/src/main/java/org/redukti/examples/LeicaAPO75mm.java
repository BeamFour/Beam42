...
public class LeicaAPO75mm {
    ...
    public static void main(String[] args) throws Exception {
        ...
        var analysis = new Analysis(prescription, new double[]{0.0,0.3,0.7}, new int[] {10,20,40});
...
//                        new GoalSpotMaxRadius(analysis, 4, 60.0, 1.0),
                        ...
                        new GoalGeoMTF(analysis,1,0,10,0.95,1.0),
                        new GoalGeoMTF(analysis,1,1,10,0.95,1.0),
                        new GoalGeoMTF(analysis,2,0,10,0.91,1.2),
                        new GoalGeoMTF(analysis,2,1,10,0.91,1.2),
                        new GoalGeoMTF(analysis,3,0,10,0.85,1.0),
                        new GoalGeoMTF(analysis,3,1,10,0.85,1.0),
//                        new GeoMTF(analysis,4,0,10,0.8,1.0),
//                        new GeoMTF(analysis,4,1,10,0.8,1.0),
                        // below are figures from patent
                        new GoalGeoMTF(analysis,1,0,20,0.85,1.0),
                        new GoalGeoMTF(analysis,1,1,20,0.85,1.0),
                        new GoalGeoMTF(analysis,2,0,20,0.80,1.1),
                        new GoalGeoMTF(analysis,2,1,20,0.80,1.1),
                        new GoalGeoMTF(analysis,3,0,20,0.70, 1.0),
                        new GoalGeoMTF(analysis,3,1,20,0.70,1.0),
//                        new GeoMTF(analysis,4,0,20,0.6,1.0),
//                        new GeoMTF(analysis,4,1,20,0.6,1.0),

                        new GoalGeoMTF(analysis,1,0,40,0.65,1.1),
                        new GoalGeoMTF(analysis,1,1,40,0.65,1.1),
                        new GoalGeoMTF(analysis,2,0,40,0.64,1.1),
                        new GoalGeoMTF(analysis,2,1,40,0.64,1.1),
                        new GoalGeoMTF(analysis,3,0,40,0.40,1.0),
                        new GoalGeoMTF(analysis,3,1,40,0.40,1.0),
