...
package org.redukti.render.rendering;
...
import static org.redukti.render.rendering.Renderer.Style.StyleBackground;
...
public class RendererSvg extends Renderer2d {
    ...
    void svg_add_stroke_width() {
        if (_stroke_width != 1.0)
            _out.append(" stroke-width=\"").append(format(_stroke_width)).append("\"");
    }
