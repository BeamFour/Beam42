...
| 7 | 73.518 | 12.75 | 55.64 | 1.5522 | 67.06 | CORNING | B52-67 |
...
| parameter | value |
| ---       | ---   |
| effective_focal_length |279.199
| back_focal_length | 69.295
| optical_invariant | 3.815
| object_distance | 1.0E10
| image_distance | 69.295
| power | 0.004
| pp1_H | -142.885
| ppk_H' | -209.904
| ffl_F | -422.084
...
| ---   | ---              | ---             |
 | Field(x=0.0, y=0.0) | 2.346 | 4.725|
 | Field(x=0.0, y=0.1) | 2.926 | 9.825|
 | Field(x=0.0, y=0.2) | 3.853 | 16.42|
 | Field(x=0.0, y=0.3) | 4.057 | 15.395|
 | Field(x=0.0, y=0.4) | 4.289 | 16.612|
 | Field(x=0.0, y=0.5) | 4.756 | 18.518|
 | Field(x=0.0, y=0.6) | 5.202 | 21.062|
 | Field(x=0.0, y=0.7) | 5.668 | 19.133|
 | Field(x=0.0, y=0.8) | 5.758 | 20.068|
 | Field(x=0.0, y=0.9) | 7.734 | 28.964|
 | Field(x=0.0, y=1.0) | 12.388 | 40.507|
