...
public class GlassMap extends Solid {
    ...
    static {
        ...
        glasses.put("S-FPM 2", new GlassMap("Ohara", "S-FPM2", 1.59522, 1.59255, 1.60134));
        glasses.put("S-FPM 3", new GlassMap("Ohara", "S-FPM3", 1.53775, 1.53555, 1.54275));
        glasses.put("S-FPM 4", new GlassMap("Ohara", "S-FPM4", 1.52841, 1.5263, 1.53321));
        glasses.put("S-FPM 5", new GlassMap("Ohara", "S-FPM5", 1.552, 1.54963, 1.55743));
        glasses.put("S-FSL 5", new GlassMap("Ohara", "S-FSL5", 1.48749, 1.48534, 1.49228));
        glasses.put("S-BSL 7", new GlassMap("Ohara", "S-BSL7", 1.51633, 1.51386, 1.52191));
        glasses.put("S-BSM 2", new GlassMap("Ohara", "S-BSM2", 1.60738, 1.60414, 1.61483));
        ...
        glasses.put("S-NSL 3", new GlassMap("Ohara", "S-NSL3", 1.51823, 1.51556, 1.52435));
        ...
        glasses.put("S-BAL 2", new GlassMap("Ohara", "S-BAL2", 1.57099, 1.56762, 1.57886));
        glasses.put("S-BAL 3", new GlassMap("Ohara", "S-BAL3", 1.57135, 1.5681, 1.57889));
        ...
        glasses.put("S-TIL 1", new GlassMap("Ohara", "S-TIL1", 1.54814, 1.54457, 1.55654));
        glasses.put("S-TIL 2", new GlassMap("Ohara", "S-TIL2", 1.54072, 1.5373, 1.54875));
        glasses.put("S-TIL 6", new GlassMap("Ohara", "S-TIL6", 1.53172, 1.52846, 1.53934));
        ...
        glasses.put("S-TIM 2", new GlassMap("Ohara", "S-TIM2", 1.62004, 1.61502, 1.63212));
        glasses.put("S-TIM 5", new GlassMap("Ohara", "S-TIM5", 1.60342, 1.59875, 1.61462));
        glasses.put("S-TIM 8", new GlassMap("Ohara", "S-TIM8", 1.59551, 1.59103, 1.60621));
        ...
        glasses.put("S-TIH 1", new GlassMap("Ohara", "S-TIH1", 1.71736, 1.71033, 1.73463));
        glasses.put("S-TIH 3", new GlassMap("Ohara", "S-TIH3", 1.74, 1.73245, 1.75861));
        glasses.put("S-TIH 4", new GlassMap("Ohara", "S-TIH4", 1.7552, 1.7473, 1.77475));
        glasses.put("S-TIH 6", new GlassMap("Ohara", "S-TIH6", 1.80518, 1.79611, 1.82777));
        ...
        glasses.put("S-LAL 7", new GlassMap("Ohara", "S-LAL7", 1.6516, 1.64821, 1.65934));
        glasses.put("S-LAL 7Q", new GlassMap("Ohara", "S-LAL7Q", 1.6516, 1.64819, 1.65932));
        glasses.put("S-LAL 8", new GlassMap("Ohara", "S-LAL8", 1.713, 1.70897, 1.72221));
        glasses.put("S-LAL 9", new GlassMap("Ohara", "S-LAL9", 1.691, 1.68717, 1.69977));
        ...
        glasses.put("S-LAM 2", new GlassMap("Ohara", "S-LAM2", 1.744, 1.73905, 1.75566));
        glasses.put("S-LAM 3", new GlassMap("Ohara", "S-LAM3", 1.717, 1.71253, 1.72749));
        glasses.put("S-LAM 7", new GlassMap("Ohara", "S-LAM7", 1.7495, 1.74328, 1.76452));
        ...
        glasses.put("S-NBH 5", new GlassMap("Ohara", "S-NBH5", 1.65412, 1.64923, 1.66571));
        glasses.put("S-NBH 8", new GlassMap("Ohara", "S-NBH8", 1.72047, 1.71437, 1.73512));
        ...
        glasses.put("S-NPH 1", new GlassMap("Ohara", "S-NPH1", 1.80809, 1.79801, 1.83351));
        glasses.put("S-NPH 1W", new GlassMap("Ohara", "S-NPH1W", 1.80809, 1.79801, 1.83351));
        glasses.put("S-NPH 2", new GlassMap("Ohara", "S-NPH2", 1.92286, 1.90916, 1.958));
        glasses.put("S-NPH 3", new GlassMap("Ohara", "S-NPH3", 1.95906, 1.94376, 1.99866));
        glasses.put("S-NPH 4", new GlassMap("Ohara", "S-NPH4", 1.89286, 1.88048, 1.92433));
        glasses.put("S-NPH 5", new GlassMap("Ohara", "S-NPH5", 1.85896, 1.84821, 1.886));
        glasses.put("S-NPH 7", new GlassMap("Ohara", "S-NPH7", 1.7783, 1.76902, 1.80157));
