...
import org.redukti.data.DataSet;
...
public class Plot {
     ...
     */
    public PlotData add_plot_data(DataSet data, Rgb color,
     ...
     * Add plot data
     */
    public void add_plot_data(PlotData data) {
        _plots.add(data);
    }
     ...
     */
    public void set_different_colors() {
        Rgb color;
        int n = 1;
     ...
     */
    public void set_xy_swap(boolean doswap) {
        _xy_swap = doswap;
    }
