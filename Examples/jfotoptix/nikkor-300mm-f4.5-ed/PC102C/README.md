...
| --- | ---    | ---       | ---      | --- | --- | ---        | ---   |
| 1 | 133.0 | 12.0 | 67.6 | 1.50032 | 81.9 | Hikari | PC102C |
| 2 | -140.0 | 4.0 | 67.6 |  |  |  |
| 3 | -128.0 | 3.0 | 65.36 | 1.61266 | 44.4 | Hikari | KZFH1 |
| 4 | 70.0 | 9.0 | 65.36 | 1.6393 | 45.0 | Schott | BAF12-Old |
| 5 | 316.3 | 1.0 | 65.36 |  |  |  |
| 6 | 82.75 | 7.7 | 65.43 | 1.50032 | 81.9 | Hikari | PC102C |
| 7 | 322.4 | 80.0 | 65.43 |  |  |  |
| 8 | AS | 35.0 | 30.635 |  |  |  |
...
| ---   | ---              | ---             |
 | Field(x=0.0, y=0.0) | 5.043 | 11.208|
 | Field(x=0.0, y=0.1) | 5.175 | 15.527|
 | Field(x=0.0, y=0.2) | 5.184 | 15.845|
 | Field(x=0.0, y=0.3) | 5.413 | 17.406|
 | Field(x=0.0, y=0.4) | 5.804 | 18.914|
 | Field(x=0.0, y=0.5) | 6.288 | 20.513|
 | Field(x=0.0, y=0.6) | 7.065 | 22.274|
 | Field(x=0.0, y=0.7) | 8.06 | 24.1|
 | Field(x=0.0, y=0.8) | 9.244 | 25.872|
 | Field(x=0.0, y=0.9) | 10.598 | 27.463|
 | Field(x=0.0, y=1.0) | 11.967 | 28.802|
