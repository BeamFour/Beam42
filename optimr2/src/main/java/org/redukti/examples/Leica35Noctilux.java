...
public class Leica35Noctilux {
    ...
    // Beam43\Examples\jfotoptix\leica-m-35mm-f1.2\ver-2i\US20250271647_Example02i.txt
...
//                        new GoalSpotMaxRadius(analysis, 4, 60.0, 1.0),
                ...
                new GoalGeoMTF(analysis,1,0,10,0.99,1.3),
                new GoalGeoMTF(analysis,1,1,10,0.99,1.3),
                new GoalGeoMTF(analysis,2,0,10,0.99,1.2),
                new GoalGeoMTF(analysis,2,1,10,0.99,1.2),
                new GoalGeoMTF(analysis,3,0,10,0.95,1.1),
                new GoalGeoMTF(analysis,3,1,10,0.95,1.1),
                new GoalGeoMTF(analysis,4,0,10,0.9,1.0),
                new GoalGeoMTF(analysis,4,1,10,0.7,1.0),
                // below are figures from patent
                new GoalGeoMTF(analysis,1,0,20,0.9,1.3),
                new GoalGeoMTF(analysis,1,1,20,0.9,1.3),
                new GoalGeoMTF(analysis,2,0,20,0.9,1.2),
                new GoalGeoMTF(analysis,2,1,20,0.9,1.2),
                new GoalGeoMTF(analysis,3,0,20,0.8,1.1),
                new GoalGeoMTF(analysis,3,1,20,0.8,1.1),
                new GoalGeoMTF(analysis,4,0,20,0.7,1.0),
                new GoalGeoMTF(analysis,4,1,20,0.5,1.1),

                new GoalGeoMTF(analysis,1,0,40,0.8,1.3),
                new GoalGeoMTF(analysis,1,1,40,0.8,1.3),
                new GoalGeoMTF(analysis,2,0,40,0.7,1.2),
                new GoalGeoMTF(analysis,2,1,40,0.7,1.2),
                new GoalGeoMTF(analysis,3,0,40,0.6,1.1),
                new GoalGeoMTF(analysis,3,1,40,0.6,1.1),
                new GoalGeoMTF(analysis,4,0,40,0.5,1.0),
                new GoalGeoMTF(analysis,4,1,40,0.3,1.0),
