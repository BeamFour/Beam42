        ...
        var f = new MeritFunction(analysis,
                ...
                new Goal[] {
                      ...
                      new GoalSpotMaxRadius(analysis, 6, 120.0, 2.0),
                        new GoalGeoMTF(analysis,1,0,10,0.8,1.0),
                        new GoalGeoMTF(analysis,1,1,10,0.8,1.0),
                        new GoalGeoMTF(analysis,2,0,10,0.8,1.0),
                        new GoalGeoMTF(analysis,2,1,10,0.8,1.0),
                        new GoalGeoMTF(analysis,3,0,10,0.86,1.0),
                        new GoalGeoMTF(analysis,3,1,10,0.82,1.0),
                        new GoalGeoMTF(analysis,4,0,10,0.7,1.0),
                        new GoalGeoMTF(analysis,4,1,10,0.5,1.0),
                        new GoalGeoMTF(analysis,1,0,30,0.5,1.0),
                        new GoalGeoMTF(analysis,1,1,30,0.5,1.0),
                        new GoalGeoMTF(analysis,2,0,30,0.55,1.0),
                        new GoalGeoMTF(analysis,2,1,30,0.55,1.0),
                        new GoalGeoMTF(analysis,3,0,30,0.55,1.0),
                        new GoalGeoMTF(analysis,3,1,30,0.55,1.0),
                        new GoalGeoMTF(analysis,4,0,30,0.28,1.0),
                        new GoalGeoMTF(analysis,4,1,30,0.23,1.0),
