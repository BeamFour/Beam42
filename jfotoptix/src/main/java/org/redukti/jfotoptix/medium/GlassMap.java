...
public class GlassMap extends Solid {
    ...
    static {
        ...
        glasses.put("N-PSK53A", new GlassMap("Schott", "N-PSK53A", 1.618, 1.61503, 1.62478));   // 63.39
        ...
        glasses.put("S-TIL25", new GlassMap("Ohara", "S-TIL25", 1.58144, 1.57722, 1.59149));    // 40.75
