...
//                        new GoalSpotMaxRadius(analysis, 6, 500.0, 1.0),
                        ...
                        new GoalGeoMTF(analysis,1,0,10,0.7,1.0),
                        new GoalGeoMTF(analysis,1,1,10,0.7,1.0),
                        new GoalGeoMTF(analysis,2,0,10,0.5,1.0),
                        new GoalGeoMTF(analysis,2,1,10,0.5,1.0),
                        new GoalGeoMTF(analysis,3,0,10,0.6,1.0),
                        new GoalGeoMTF(analysis,3,1,10,0.6,1.0),
                        new GoalGeoMTF(analysis,4,0,10,0.2,1.0),
                        new GoalGeoMTF(analysis,4,1,10,0.2,1.0),

                        new GoalGeoMTF(analysis,1,0,20,0.6,1.0),
                        new GoalGeoMTF(analysis,1,1,20,0.6,1.0),
                        new GoalGeoMTF(analysis,2,0,20,0.4,1.0),
                        new GoalGeoMTF(analysis,2,1,20,0.4,1.0),
                        new GoalGeoMTF(analysis,3,0,20,0.55,1.0),
                        new GoalGeoMTF(analysis,3,1,20,0.55,1.0),
                        new GoalGeoMTF(analysis,4,0,20,0.15,1.0),
                        new GoalGeoMTF(analysis,4,1,20,0.15,1.0),

                        new GoalGeoMTF(analysis,1,0,40,0.5,1.0),
                        new GoalGeoMTF(analysis,1,1,40,0.5,1.0),
                        new GoalGeoMTF(analysis,2,0,40,0.4,1.0),
                        new GoalGeoMTF(analysis,2,1,40,0.4,1.0),
                        new GoalGeoMTF(analysis,3,0,40,0.5,1.0),
                        new GoalGeoMTF(analysis,3,1,40,0.5,1.0),
                        new GoalGeoMTF(analysis,4,0,40,0.1,1.0),
                        new GoalGeoMTF(analysis,4,1,40,0.1,1.0),
