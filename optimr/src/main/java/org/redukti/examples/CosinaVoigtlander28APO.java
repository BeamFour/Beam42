...
public class CosinaVoigtlander28APO {
...
//        var analysis = new Analysis(prescription, new double[]{0.0,0.25,0.75,1.0}, new int[] {40});
...
//                    new VarRadius(prescription, 13),
                     new VarThickness(prescription, 20)
...
//                        new GeoMTF(analysis,4,1,10,0.75,1.0),
                        ...
                        new GoalGeoMTF(analysis,1,0,10,0.98,1.0),
                        new GoalGeoMTF(analysis,1,1,10,0.98,1.0),
                        new GoalGeoMTF(analysis,2,0,10,0.95,1.0),
                        new GoalGeoMTF(analysis,2,1,10,0.97,1.0),
                        new GoalGeoMTF(analysis,3,0,10,0.95,1.0),
                        new GoalGeoMTF(analysis,3,1,10,0.95,1.0),
                        new GoalGeoMTF(analysis,4,0,10,0.90,1.0),
                        new GoalGeoMTF(analysis,4,1,10,0.90,1.0),

                        new GoalGeoMTF(analysis,1,0,20,0.88,1.0),
                        new GoalGeoMTF(analysis,1,1,20,0.88,1.0),
                        new GoalGeoMTF(analysis,2,0,20,0.75,1.0),
                        new GoalGeoMTF(analysis,2,1,20,0.87,1.0),
                        new GoalGeoMTF(analysis,3,0,20,0.73,1.0),
                        new GoalGeoMTF(analysis,3,1,20,0.80,1.0),
                        new GoalGeoMTF(analysis,4,0,20,0.60,1.0),
                        new GoalGeoMTF(analysis,4,1,20,0.60,1.0),

                        new GoalGeoMTF(analysis,1,0,40,0.81,1.0),
                        new GoalGeoMTF(analysis,1,1,40,0.81,1.0),
                        new GoalGeoMTF(analysis,2,0,40,0.62,1.0),
                        new GoalGeoMTF(analysis,2,1,40,0.78,1.0),
                        new GoalGeoMTF(analysis,3,0,40,0.62,1.0),
                        new GoalGeoMTF(analysis,3,1,40,0.70,1.0),
                        new GoalGeoMTF(analysis,4,0,40,0.55,1.0),
                        new GoalGeoMTF(analysis,4,1,40,0.55,1.0),
...
//                        new GeoMTF(analysis,4,1,50,0.5,1.0),
                      new GoalParax(analysis, ParaxHelper.Effective_focal_length,28.84, 1.0),
                      new GoalParax(analysis, ParaxHelper.Fno, 2.06, 1.0),
