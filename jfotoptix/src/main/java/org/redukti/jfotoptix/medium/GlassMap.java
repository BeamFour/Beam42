...
public class GlassMap extends Solid {
    ...
    static {
        ...
        glasses.put("FCD515", new GlassMap("Hoya", "FCD515", 1.59282, 1.59021, 1.59884));
        ...
        glasses.put("E-FDS1",new GlassMap("Hoya", "E-FDS1",1.92286,1.91038,1.95457));
        ...
        glasses.put("FDS18",new GlassMap("Hoya", "FDS18",1.94595,1.93123,1.98383));
        glasses.put("FDS20-W ",new GlassMap("Hoya", "FDS20-W ",1.86966,1.85742,1.90086));
        glasses.put("FDS24",new GlassMap("Hoya", "FDS24",1.92119,1.9102,1.94865));
        ...
        glasses.put("TAF1",new GlassMap("Hoya", "TAF1",1.7725,1.7678,1.78336));
        glasses.put("TAF3D",new GlassMap("Hoya", "TAF3D",1.8042,1.799,1.8163));
        ...
        glasses.put("TAFD35",new GlassMap("Hoya", "TAFD35",1.91082,1.90323,1.92907));
        ...
        glasses.put("TAFD45",new GlassMap("Hoya", "TAFD45",1.95375,1.94513,1.97465));
        ...
        glasses.put("M-TAF101",new GlassMap("Hoya", "M-TAF101",1.76802,1.76331,1.77891));
        ...
        glasses.put("N-KZFS8",new GlassMap("Schott", "N-KZFS8",1.72047,1.71437,1.73513));
        ...
        // Ohara
        glasses.put("S-FPL51",new GlassMap("Ohara", "S-FPL51",1.497,1.49514,1.50123));
        ...
        glasses.put("S-FPM 2",new GlassMap("Ohara", "S-FPM 2",1.59522,1.59255,1.60134));
        glasses.put("S-FPM 3",new GlassMap("Ohara", "S-FPM 3",1.53775,1.53555,1.54275));
        glasses.put("S-FPM 4",new GlassMap("Ohara", "S-FPM 4",1.52841,1.5263,1.53321));
        glasses.put("S-FPM 5",new GlassMap("Ohara", "S-FPM 5",1.552,1.54963,1.55743));
        glasses.put("S-FSL 5",new GlassMap("Ohara", "S-FSL 5",1.48749,1.48534,1.49228));
        glasses.put("S-BSL 7",new GlassMap("Ohara", "S-BSL 7",1.51633,1.51386,1.52191));
        glasses.put("S-BSM 2",new GlassMap("Ohara", "S-BSM 2",1.60738,1.60414,1.61483));
        ...
        glasses.put("S-BAM 4",new GlassMap("Ohara", "S-BAM 4",1.60562,1.60151,1.61536));
        ...
        glasses.put("S-PHM52",new GlassMap("Ohara", "S-PHM52",1.618,1.61504,1.62479));
        ...
        glasses.put("S-TIL 1",new GlassMap("Ohara", "S-TIL 1",1.54814,1.54457,1.55654));
        glasses.put("S-TIL 2",new GlassMap("Ohara", "S-TIL 2",1.54072,1.5373,1.54875));
        glasses.put("S-TIL 6",new GlassMap("Ohara", "S-TIL 6",1.53172,1.52846,1.53934));
        ...
        glasses.put("S-TIM 2",new GlassMap("Ohara", "S-TIM 2",1.62004,1.61502,1.63212));
        glasses.put("S-TIM 5",new GlassMap("Ohara", "S-TIM 5",1.60342,1.59875,1.61462));
        glasses.put("S-TIM 8",new GlassMap("Ohara", "S-TIM 8",1.59551,1.59103,1.60621));
        ...
        glasses.put("S-TIH 1",new GlassMap("Ohara", "S-TIH 1",1.71736,1.71033,1.73463));
        glasses.put("S-TIH 3",new GlassMap("Ohara", "S-TIH 3",1.74,1.73245,1.75861));
        glasses.put("S-TIH 4",new GlassMap("Ohara", "S-TIH 4",1.7552,1.7473,1.77475));
        glasses.put("S-TIH 6",new GlassMap("Ohara", "S-TIH 6",1.80518,1.79611,1.82777));
        ...
        glasses.put("S-LAL 7",new GlassMap("Ohara", "S-LAL 7",1.6516,1.64821,1.65934));
        glasses.put("S-LAL 7Q",new GlassMap("Ohara", "S-LAL 7Q",1.6516,1.64819,1.65932));
        glasses.put("S-LAL 8",new GlassMap("Ohara", "S-LAL 8",1.713,1.70897,1.72221));
        glasses.put("S-LAL 9",new GlassMap("Ohara", "S-LAL 9",1.691,1.68717,1.69977));
        ...
        glasses.put("S-LAM 2",new GlassMap("Ohara", "S-LAM 2",1.744,1.73905,1.75566));
        glasses.put("S-LAM 3",new GlassMap("Ohara", "S-LAM 3",1.717,1.71253,1.72749));
        glasses.put("S-LAM 7",new GlassMap("Ohara", "S-LAM 7",1.7495,1.74328,1.76452));
        ...
        glasses.put("S-LAH89",new GlassMap("Ohara", "S-LAH89",1.8515,1.8453,1.86618));
        ...
        glasses.put("S-LAH99",new GlassMap("Ohara", "S-LAH99",2.001,1.99105,2.0254));
        glasses.put("S-FTM16",new GlassMap("Ohara", "S-FTM16",1.5927,1.58779,1.60458));
        glasses.put("S-NBM51",new GlassMap("Ohara", "S-NBM51",1.6134,1.60925,1.62311));
        glasses.put("S-NBH 5",new GlassMap("Ohara", "S-NBH 5",1.65412,1.64923,1.66571));
        glasses.put("S-NBH 8",new GlassMap("Ohara", "S-NBH 8",1.72047,1.71437,1.73512));
        glasses.put("S-NBH51",new GlassMap("Ohara", "S-NBH51",1.7495,1.74326,1.76447));
        glasses.put("S-NBH52V",new GlassMap("Ohara", "S-NBH52V",1.673,1.66779,1.68538));
