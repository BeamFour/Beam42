...
//                        new GoalSpotMaxRadius(analysis, 4, 60.0, 1.0),
                        ...
                        new GeoMTF(analysis,2,0,10,0.91,1.2),
                        new GeoMTF(analysis,2,1,10,0.91,1.2),
...
//                        new GeoMTF(analysis,4,1,10,0.8,1.0),
                        ...
                        new GeoMTF(analysis,1,0,20,0.85,1.0),
                        new GeoMTF(analysis,1,1,20,0.85,1.0),
...
//                        new GeoMTF(analysis,4,1,20,0.6,1.0),
                        ...
                        new GeoMTF(analysis,1,0,40,0.65,1.1),
                        new GeoMTF(analysis,1,1,40,0.65,1.1),
