...
public class LeicaSummicron35APO {
    ...
    public static void main(String[] args) throws Exception {
        ...
        var analysis = new Analysis(prescription, new double[]{0.0,0.25,0.75,1.0}, new int[] {30});
...
//                        new GoalSpotMaxRadius(analysis, 4, 20.0, 1.0),
                        new GeoMTF(analysis,1,0,30,0.75,1.0),
                        new GeoMTF(analysis,1,1,30,0.75,1.0),
                        new GeoMTF(analysis,2,0,30,0.7,1.0),
                        new GeoMTF(analysis,2,1,30,0.7,1.0),
                        new GeoMTF(analysis,3,0,30,0.65,1.0),
                        new GeoMTF(analysis,3,1,30,0.65,1.0),
                        new GeoMTF(analysis,4,0,30,0.5,1.0),
