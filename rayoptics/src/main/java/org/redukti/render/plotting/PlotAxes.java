...
package org.redukti.render.plotting;
...
public class PlotAxes {
    ...
    public static final class Axis {
        ...
        public boolean _axis;
        public boolean _tics;
        public boolean _values;

        public step_mode_e _step_mode;
        public int _count;
        public double _step_base;
        public boolean _si_prefix;
        public boolean _pow10_scale;
        public int _pow10;

        public String _unit;
        public String _label;
        public Range _range;    // Default is (0,0) meaning automatic range
    }
     ...
     */
    public void set_tics_step(double step, AxisMask a) {
    ...
    public void set_tics_step(double step) {
    ...
    public void set_tics_count(int count) {
     ...
     * set_tics_count}
     */
    public void set_tics_base(int min_count, double base, AxisMask a) {
        for (int i = 0; i < _axes_bits.length; i++) {
            if ((a.get_value() & _axes_bits[i]) != 0) {
     ...
     * step.
     */
    public void set_show_grid(boolean show) {
        _grid = show;
    }
     ...
     */
    public void set_show_frame(boolean show) {
        _frame = show;
    }
     ...
     * see set_show_axes
     */
    public boolean get_show_axes(int axis) {
     ...
     */
    public void set_show_tics(boolean show, AxisMask a) {
        for (int i = 0; i < _axes_bits.length; i++) {
            if ((a.get_value() & _axes_bits[i]) != 0) {
                _axes[i]._tics = show;
                _axes[i]._axis |= show;
     ...
     * see set_show_tics
     */
    public boolean get_show_tics(int axis) {
     ...
     */
    public void set_show_values(boolean show, AxisMask a) {
        for (int i = 0; i < _axes_bits.length; i++) {
            if ((a.get_value() & _axes_bits[i]) != 0) {
     ...
     * see set_show_values
     */
    public boolean get_show_values(int axis) {
     ...
     * Get axis label
     */
    public String get_label(int axis) {
